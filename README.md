...
| Skill | Description |
|-------|-------------|
| [better-auth-device-authorization](./better-auth-device-authorization/) | Implement OAuth 2.0 Device Authorization Grant (RFC 8628) in Better Auth for CLIs, smart TVs, and IoT devices |
| [better-forms](./better-forms/) | Accessible, high-UX form patterns for React/Next.js, Tailwind, and Zod |
